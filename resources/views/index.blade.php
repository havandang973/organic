            ...
            <div class="form-row align-items-center mt-5">
                <div class="col-md-4">
                    <div class="testimonial-img text-center">
                        <div class="img">
                            <img class="w-100"
                                src="https://kenh14cdn.com/203336854389633024/2022/9/11/photo-1-1662914854718393712664.jpg"
                                alt="">
                        </div>
                ...
                <div class="col-md-8">
                    <div class="testimonial-text">
                        <div class="testimonial-info">
                            <p>“ Sản phẩm sạch, tươi và rất tốt cho sức khỏe. Tôi rất hài lòng với chất lượng và dịch vụ
                                của cửa hàng.</p>
                            <h3>Nguyễn Văn A</h3>
                        ...
                        <div class="testimonial-info">
                            <p>“ Món ăn rất ngon, giá cả hợp lý và nhân viên phục vụ nhiệt tình. Tôi sẽ quay lại lần
                                sau.</p>
                            <h3>Trần Thị B</h3>
                            <h4>Khách hàng hài lòng</h4>
                        </div>
                        ...
                        <div class="testimonial-info">
                            <p>“ Chất lượng sản phẩm vượt trội, tôi hoàn toàn tin tưởng khi mua sắm tại đây. Đánh giá 5
                                sao!</p>
                            <h3>Lê Văn C</h3>
                            <h4>Khách hàng hài lòng</h4>
                        </div>
