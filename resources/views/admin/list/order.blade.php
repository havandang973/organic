                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @if ($paymentMethod) 
                                <ul class="list-disc">
                                    ...
                                    <li>Ngân hàng: {{ $paymentMethod['bank'] ?? '' }}</li>
                                    <li>Mã thanh toán: {{ $paymentMethod['transaction_code'] ?? '' }}</li>
                        ...
                        <td>
                            ...
                            <a href="{{route('delete.order', $order->order_code)}}" class="btn bg-red-500 btn-danger btn-sm rounded-0 text-white" type="button" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash"></i></a>
                            <a href="{{route('order.invoice', $order->id)}}" target="_blank" class="btn bg-blue-500 btn-primary btn-sm rounded-0 text-white" type="button" data-toggle="tooltip" data-placement="top" title="Print"><i class="fa-solid fa-print"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
